...
from .api.views import index_view, LoginMessageViewSet, GetHistoryData, WaterQualityDataViewSet, ExportDataViewSet, FishDataViewSet, GetFishData
...
# water-fish_data
router.register('fish_data', GetFishData, basename='fish_data')
